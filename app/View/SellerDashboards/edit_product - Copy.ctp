                                                                    ...
                                                                    <div class='col-lg-8 col-md-8 col-sm-12 col-xs-12'>
                                                                        <div class='form-group custom_font-edit'>
                                                                            ...
                                                                            <select name='require1[]'>
                                                                                <option <?php echo ($option_val['option_name']['require_val'] == 'Yes' ? 'selected="selected"' : '') ?>>Yes</option>
                                                                                <option <?php echo ($option_val['option_name']['require_val'] == 'No' ? 'selected="selected"' : '') ?>>No</option>
                                                                            </select>
                                                                        </div>
