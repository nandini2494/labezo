    ...
    <body>
            ...
            <div class="left-container" id="left-container">
                ...
                <div class="left-sidebar new_left_slide_bar" id="show-nav">
                    <ul class="side-nav">
                        ...
                        <li>
                            <a href='product_info.html' class='active'><span class="icon-Product_info"></span> Product Information
                            </a>
                        </li>
                        <li>
                ...
                <div class='container-fluid'>
                    ...
                    <div class="">
                        <div class="">
                            ...
                            <div class="col-md-12">
                                <form method="post">
                                    <a class='pull-right new_add_table_use' href="add_product.html">Add Information</a>
                                    &nbsp;&nbsp;                                
                                    ...
                                    <table id="mytable" class="table table-bordred table-striped">
                                        ...
                                        <tbody class="product">
                                            ...
                                            <?php 
                                                ...
                                                $image = explode(",",$value['product']['product_image']);                                                
                                            ?>
                                            <tr>
                                                <td><?php echo $value['product']['product_name'] ?></td>
                                                <td><img src="<?php echo DOMAIN_NAME ?><?php echo $value['product']['image'] ?>" class="img_useful"></td>
                                                <td><?php echo $value['product']['product_model'] ?></td>
                                                <td><?php echo $value['product']['price'] ?></td>
                                                <td><?php echo $value['product']['quantity'] ?></td>
                                                <td>
                                                    <?php if ($value['product']['status'] == '1') { 
                                                        echo "Enabled";
                                                    }else{
                                                        echo "Disabled";
                                                    } ?>
                                                </td>                                                                                                        
                                                <td><a href="edit_product.html?id=<?php echo $value['product']['product_id'] ?>" class="btn btn-primary btn-xs" ><span class="glyphicon glyphicon-pencil"></span></a></td>
                                                <td><p data-placement="top" data-toggle="tooltip" title="Delete"><button class="btn btn-danger btn-xs" onclick='delete_data("<?php echo $value['product']['product_id'] ?>")'><span class="glyphicon glyphicon-trash"></span></button></p></td>
                                            </tr>
                                            <?php } } else { ?>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" name="product_id3" id="product_id2">
        ...
        <script>
            $("#delete_modal").submit(function () {
                $.ajax({
                    url: "<?php echo Router::url(['controller' => 'sellerDashboards/delete_product']) ?>",
                    type: "post",
