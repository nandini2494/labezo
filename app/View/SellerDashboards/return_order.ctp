                                ...
                                <div class="panel panel-default panel-table new_table_use">
                                    <div class="panel-heading">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="pull-right">
                                                <a href="return_order_admin.html" class="active_use_button_use">Admin</a>
                                            </div>
                                            <!-- <div class="pull-right">
                                                <div class="pull-right">
                                    ...
                                    <div class="panel-body">
                                        <table id="mytable" class="table table-striped table-bordered table-list">
                                            ...
                                            <td>
                                                <?php if($product['return_product']['return_status'] == 'Completed') { ?>
                                                Completed
                                                <?php } else { ?>
                                                <div>
                                                    <form method="post">
                                                        <input type="hidden" name="product" value="<?php echo $product['return_product']['product_name'] ?>">
                                                        <input type="hidden" name="order_id" value="<?php echo $product['return_product']['order_id'] ?>">
                                                        <input type="hidden" name="email" value="<?php echo $product['buyer_register']['email'] ?>">
                                                        <input type="hidden" name="return_id" value="<?php echo $product['return_product']['id'] ?>"> 
                                                        <select class='box_list pending_data_list' name="select_list">
                                                            <option value="Took Back" <?php echo ($product['return_product']['return_status'] == 'Took Back' ? 'selected = "selected"' : '') ?>>Took Back</option>
                                                            <option value="Recived by Seller" <?php echo ($product['return_product']['return_status'] == 'Recived by Seller' ? 'selected = "selected"' : '') ?>>Recived by Seller</option>                                                            
                                                            <option value="Amount transfered" <?php echo ($product['return_product']['return_status'] == 'Amount transfered' ? 'selected = "selected"' : '') ?>>Amount transfered</option>
                                                            <option value="Completed" <?php echo ($product['return_product']['return_status'] == 'Completed' ? 'selected = "selected"' : '') ?>>Completed</option>
                                                        </select>
