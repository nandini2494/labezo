        ...
        <div class="content">
            ...
            <div class="login">
                <div class="main-agileits">
                    <div class="form-w3agile">
                        ...
                        <form method="post">
                            <div class="key">
                                ...
                                <input name="email" type="text" value="Email" onfocus="this.value = '';" onblur="if (this.value == '') {
                                            this.value = 'Email';}" required="">
                                <div class="clearfix"></div>
                            </div>
                            <div class="key">
                                <i class="fa fa-lock" aria-hidden="true"></i>
                                <input name="password" type="password" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {
                                            this.value = 'Password';
                                        }" required="">
                                <div class="clearfix"></div>
                            </div>
                    ...
                    <div class="forg">
                        <a href="forget.html" class="forg-left">Forgot Password</a>
