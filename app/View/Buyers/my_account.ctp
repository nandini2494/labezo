                            ...
                            <div class="personal_info">
                                ...
                                <form method="post">                                                                       
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="firstname" placeholder="First Name" type="text" value="<?php echo $data['buyer_register']['firstname'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Last Name:</label>
                                        <input class="form-control" name="lastname" placeholder="Last Name"  value="<?php echo $data['buyer_register']['lastname'] ?>" type="text">
                                    </div>
                                    <div class="form-group">
                                        <label>Phone No:</label>
                                        <input class="form-control" name="phone" placeholder="Phone" value="<?php echo $data['buyer_register']['phone'] ?>" type="text">
                                    </div>
                                    <div class="form-group">
                                        <label>Email:</label>
                                        <input class="form-control" name="email" placeholder="Email" value="<?php echo $data['buyer_register']['email'] ?>" type="email">
                                    </div>
                                    <div class="form-group">
                                        <label>Gender:</label>
                                        <select class="form-control" name="gender">
                                            <option value="">Select Gender</option>
                                            <option value="Female" <?php echo ($data['buyer_register']['gender'] == 'Female' ? 'selected="selected"' : '') ?>>Female</option>
                                            <option value="Male" <?php echo ($data['buyer_register']['gender'] == 'Male' ? 'selected="selected"' : '') ?>>Male</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
