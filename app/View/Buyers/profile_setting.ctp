                        ...
                        <div class="col-md-2 product-agileinfo-grid catagry_section">
                            <div class="categories">
                                ...
                                <ul class="tree-list-pad remove_padding">
                                    ...
                                    <li><a href="profile_setting.html"><label class="active">Profile Settings </label></a></li>
                            ...
                            <div class="personal_info">
                                <div class="title">
                                    ...
                                    <div class="note_text"><p>
                                            ...
                                            <b>Please Note:</b> Your profile name can be changed only once after registration</p></div>
                                </div>
                                ...
                                <form>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="" type="text"></input>
                                        </div></br>

                                    </div></br>
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <label>Make your wishlist public?
                                            </label>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <button type="button" class="btn btn-warning pull-right">Save Change</button>
