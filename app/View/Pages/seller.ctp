...
<html>
    ...
    <body>
                    ...
                    <ul>
                        ...
                        <li class="dropdown"><a href="#">Select Country </a>
                            <ul class="dropdown-content drop">
                                <li><a href=""><img src="img/Hongkong.png"/> Hongkong</a></li>
                                <li><a href=""><img src="img/Mexico.png"/> Mexico</a></li>
                                <li><a href=""><img src="img/Philippines.png"/> Philippines</a></li>                                
                            </ul>
        ...
        <div class="clearfix"></div>
        <div>
            <img src="<?php echo DOMAIN_NAME ?>img/buyer.jpg" class="img-responsive">
        </div>
        <section>
            <div class="heading_title container">
                <h2>Seller <strong>  Policy</strong></h2>
                <hr class="hr1"/>
