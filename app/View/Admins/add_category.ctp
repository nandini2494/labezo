                ...
                <div class="container-fluid">
                    <div class='new_div_max_use'>
                        ...
                        <div class='form-group custom'>
                            <p>Meta Keyword</p>
                            <label>
                                <input type="text" name='meta_keyword' placeholder="Meta Keyword"/>  
                            </label>
                        </div>
                        <div class='form-group custom'>
                            <p>Image</p>
                        ...
                        <div class='form-group custom'>
                            ...
                            <label>
                                ...
                                <select name="parent_id">
                                    ...
                                    <option value="<?php echo $values['category_desc']['category_id'] ?>"><?php echo $values['category_desc']['name'] ?></option>
                                    <?php } ?>
                                </select>
                                <div class='clearfix'></div>
                            </label>
