                                ...
                                <div class="panel panel-default panel-table new_table_use new_para_div">
                                    <div class="panel-heading">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="pull-right">
                                                <a href="seller_product.html" class="active_use_button_use">Seller</a>
                                            </div>
                                    ...
                                    <div class="panel-body page">
                                        <table id="mytable" class="table table-striped table-bordered table-list">
                                            ...
                                            <td>
                                                <?php if($return['return_product']['return_status'] == 'Completed') { ?>
                                                Completed
                                                <?php } else { ?>
                                                <div>
                                                    <form method="post">
                                                        <input type="hidden" name="return_id" value="<?php echo $return['return_product']['id'] ?>">
                                                        <input type="hidden" name="order_id" value="<?php echo $return['product_order']['order_id'] ?>">
                                                        <input type="hidden" name="email" value="<?php echo $return['buyer_register']['email'] ?>">
                                                        <input type="hidden" name="product" value="<?php echo $return['return_product']['product_name'] ?>">
                                                        <select class="box_list" name="select_list">
                                                            <option value="Took Back" <?php echo ($return['return_product']['return_status'] == 'Took Back' ? 'selected = "selected"' : '') ?>>Took Back</option>
                                                            <option value="Recived by Labaso" <?php echo ($return['return_product']['return_status'] == 'Recived by Labaso' ? 'selected = "selected"' : '') ?>>Recived by Labaso</option>
                                                            <option value="Moved to Seller" <?php echo ($return['return_product']['return_status'] == 'Moved to Seller' ? 'selected = "selected"' : '') ?>>Moved to Seller</option>
                                                            <option value="Seller Recieved" <?php echo ($return['return_product']['return_status'] == 'Seller Recieved' ? 'selected = "selected"' : '') ?>>Seller Recieved</option>
                                                            <option value="Amount transfered" <?php echo ($return['return_product']['return_status'] == 'Amount transfered' ? 'selected = "selected"' : '') ?>>Amount transfered</option>
                                                            <option value="Completed" <?php echo ($return['return_product']['return_status'] == 'Completed' ? 'selected = "selected"' : '') ?>>Completed</option>
                                                        </select>
                                                        <button type="submit" class="active_use_button">SAVE</button>
                                                    </form>
                                                </div>
                                                <?php } ?>
                                            </td>
