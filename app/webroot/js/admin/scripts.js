...
var itemsPerPage = 10;
var $numberOfPages;
var $studentsList = $('.product tr');
var $studentsCount = $studentsList.length;
var $studentDetails = $('.product tr .student-details');
var $searchForm;
var $searchButton;
var $searchInput;
...
function addPaginationLinks($numberOfPages) {
	...
	if($numberOfPages > 1){
		var $pagination = '';
		$pagination += '<div class="pagination  row pull-right"">';
		$pagination += '<ul>';
...
function paginate($currentPage, $studentsList) {
	...
	// set active class
	$('.pagination ul li a').removeClass( "active_page" );
	$('.pagination ul li:nth-child('+ ($currentPage) +') a').addClass( "active_page" );
}
